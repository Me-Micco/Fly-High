...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void berth_type(int s)
  {
    if (s > 0 && s < 73)
      ...
      if (s % 8 == 1 ||s % 8 == 4) {
        Fluttertoast.showToast(msg: "$s is aisle",textColor: Colors.white,fontSize: 20,gravity: ToastGravity.CENTER,backgroundColor: Color.fromRGBO(145, 201, 255, 1));
      } else {
        if (s % 8 == 2 || s % 8 == 5) {
          Fluttertoast.showToast(msg: "$s is middle",textColor: Colors.white,fontSize: 20,gravity: ToastGravity.CENTER,backgroundColor: Color.fromRGBO(145, 201, 255, 1));
        } else if(s % 8 == 3 ||s % 8 == 6) {
        Fluttertoast.showToast(msg: "$s is window berth",textColor: Colors.white,fontSize: 20,gravity: ToastGravity.CENTER,backgroundColor: Color.fromRGBO(145, 201, 255, 1));
      } else if(s % 8 == 7) {
        Fluttertoast.showToast(msg: "$s is side aisle",textColor: Colors.white,fontSize: 20,gravity: ToastGravity.CENTER,backgroundColor: Color.fromRGBO(145, 201, 255, 1));
      } else {
        Fluttertoast.showToast(msg: "$s is side window",textColor: Colors.white,fontSize: 20,gravity: ToastGravity.CENTER,backgroundColor: Color.fromRGBO(145, 201, 255, 1));
      }
      }
    else {
